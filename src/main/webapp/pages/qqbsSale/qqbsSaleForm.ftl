	...
	<form id="saveSaleWindow" action="${rc.contextPath}/qqbsSale/save"  method="post">
		<fieldset>
			...
			<#else>
			 ...
			 <!-- 特卖图片(600X260):  -->
            	特卖图片: <input type="text" readonly id="image" name="image" style="width:450px;" value="<#if saleWindow.image?exists>${saleWindow.image}</#if>" />
			...
			<#else>
				<input style="display:none" type="radio" name="isDisplay" value="1">&nbsp;&nbsp;&nbsp;
				<input style="display:none" type="radio" name="isDisplay" value="0" checked> <br/><br/>
			</#if> 

			<input type="hidden" id="saleFlagId" name="saleFlagId" value=""/><span style="color:red"></span><br/><br/>
