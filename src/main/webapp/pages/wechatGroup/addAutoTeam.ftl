...
<div data-options="region:'center',title:'商品信息'" style="padding:5px;">
	<form id="saveProduct"  method="post">
		<fieldset>
			...
			开团数：<input type='text' id='teamCount' name='teamCount' style='width:70px;'/>&nbsp;<font color='red' style='italic'>1~9 必填</font>&nbsp;&nbsp;
			团购开始时间：<input type='text' id='startTeamTime' name='startTeamTime' onClick='WdatePicker({dateFmt: &quot;yyyy-MM-dd HH:mm:ss&quot;})'/></br></br>
