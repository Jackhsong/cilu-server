...
<div data-options="region:'center',title:'商品信息'" style="padding:5px;">
	<form id="saveProduct"  method="post">
		<fieldset>
			...
			<legend>商品信息</legend>
			基本商品Id：<input id="productBaseId" name="productBaseId" maxlength="10" />
			...
			商品条码：<span id="span_barcode"></span><input type="hidden" id="barcode" name="barcode" /><br/><br/>
    		商品名称：<span id="productBaseName"></span><br/><br/>
    		商家发货名称：<input maxlength="44" type="text" id="sellerProductName" name="sellerProductName" style="width:300px;" />
    		...
    		<br/><br/>
    		<hr/>
    		商品编码：<span id="span_code"></span><input type="hidden" id="code" name="code" value="" readonly="readonly" style="width: 300px;"/><br/><br/>
    		商品商家备注：<span id="productBaseRemark"></span><br/><br/>
    		前台展示商家名称：
    		<input type="hidden" name="sellerId" id="sellerId" />
    		<span id="sellerName"></span>&nbsp;&nbsp;
    		真实商家名称：<span id="realSellerName"></span>
    		<br/><br/>
    		发货类型：<span id="sellerType"></span><br/><br/> 
    		发货地：<span id="sendAddress"></span><br/><br/> 
    		商家发货时效：<span id="sendTimeRemark"></span><br/><br/> 
			<hr/>
			
			拼团信息:<br/><br/>
    		拼团商品备注：<input maxlength="100" type="text" id="remark" name="remark"  style="width:400px;"/><br/><br/>
    		核心亮点：     <input maxlength="25" type="text" id="sellingPoint" name="sellingPoint"  style="width:400px;"/><font color="red" style="italic">必填(注：在长名称前用红色字展现，不超过6字)</font><br/><br/>
    		拼团商品长名称：<input maxlength="44" type="text" id="name" name="name"  style="width:400px;"/><font color="red" style="italic">必填</font><br/><br/>
    		拼团商品短名称：<input maxlength="25" type="text" id="shortName" name="shortName" style="width:400px;"  /><font color="red" style="italic">必填</font><br/><br/>
    		
    		详情页格格说：
				<textarea id="desc" name="desc" onkeydown="checkEnter(event)" style="height: 60px;width: 400px"></textarea>
				&nbsp;&nbsp;长度（&lt; 200）：<span style="color:red" id="counter">0 字</span><font>(注：从基本商品带过来，但是可以修改后独立保存)</font><br/><br/>
				
				
				
			拼团成功人数：<input  type="text" id="teamNumberLimit" name="teamNumberLimit"  style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
			库存数：<input  type="text" id="stock" name="stock"  style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
			开团有效时间：<input  type="text" id="teamValidHour" name="teamValidHour"  style="width:70px;"/>&nbsp;<font color="red" style="italic">（单位：分钟）必填</font></br></br>
			
			团购价：<input  type="text" id="teamPrice" name="teamPrice"  style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
			单独购买价：<input  type="text" id="singlePrice" name="singlePrice"  style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
    		市场价：<input  type="text" id="marketPrice" name="marketPrice"  style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
    		团购供货价价：<input  type="text" id="teamSupplyPrice" name="teamSupplyPrice"  style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
<!--     		排序值：<input  type="text" id="order" name="order"  style="width:70px;"/></br></br>	 -->
    		
<!--     		开始时间：<input  id="startTime" name="startTime" onClick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})"/>&nbsp;&nbsp; -->
<!--     		结束时间：<input  id="endTime" name="endTime" onClick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})"/><br/> -->
    		<hr/>
    		商品结算：<span id="submitType"></span><br/><br/>
    		运费结算：<span id="freightType"></span><br/><br/>
    		
			<hr/>		
			品牌&nbsp;&nbsp;：<span id="brandName"></span><input type="hidden" id="brandId" name="brandId"  /><br/><br/>
			净含量&nbsp;：<span id="span_netVolume"></span><input type="hidden"  id="netVolume" name="netVolume" /><br/><br/>
			产地&nbsp;&nbsp;：<span id="span_placeOfOrigin"></span><input type="hidden"  id="placeOfOrigin" name="placeOfOrigin"/><br/><br/>
			储存方法：<span id="span_storageMethod"></span><input type="hidden" id="storageMethod" name="storageMethod" /><br/><br/>
			生产日期：<span id="span_manufacturerDate"></span><input type="hidden" id="manufacturerDate" name="manufacturerDate"  /><br/><br/>
			保质期&nbsp;：<span id="span_durabilityPeriod"></span><input type="hidden" maxlength="15" id="durabilityPeriod" name="durabilityPeriod" /><br/><br/>
			适用人群：<span id="span_peopleFor"></span><input type="hidden" id="peopleFor" name="peopleFor"  /><br/><br/>
			食用方法：<span id="span_foodMethod"></span><input type="hidden" id="foodMethod" name="foodMethod"  /><br/><br/>
			使用方法：<span id="span_useMethod"></span><input type="hidden" id="useMethod" name="useMethod" /><br/><br/>
			温馨提示: 
			<textarea name="tip" id="tip" onkeydown="checkEnter(event)" style="height: 60px;width: 400px"></textarea>
			...
			<hr/> 	
		       ...
		       首页图片 <input type="text" id="productImage_1" name="productImage" style="width:450px;"   />
			...
			商品详情主图：&nbsp;<a onclick="copyInfo(1)" href="javascript:;" class="easyui-linkbutton">从基本商品表复制</a>&nbsp;&nbsp;
			...
			商品详情主图1：<input type="text" id="pic_1" name="image1" style="width:450px;"   />
			...
			商品详情主图2：<input type="text" id="pic_2" name="image2" style="width:450px;"   />
			...
			商品详情主图3：<input type="text" id="pic_3" name="image3" style="width:450px;"  />
			...
			商品详情主图4：<input type="text" id="pic_4" name="image4" style="width:450px;"   />
			...
			商品详情主图5：<input type="text" id="pic_5" name="image5" style="width:450px;"  />
			...
			图片1&nbsp;：<input type="text"  id="detail_pic_1" name="detail_pic_1" style="width:450px;" />
			...
			图片2&nbsp;：<input type="text"  id="detail_pic_2" name="detail_pic_2" style="width:450px;" />
			...
			图片3&nbsp;：<input type="text" id="detail_pic_3" name="detail_pic_3" style="width:450px;" />
			...
			图片4&nbsp;：<input type="text"  id="detail_pic_4" name="detail_pic_4" style="width:450px;" />
			...
			图片5&nbsp;：<input type="text" id="detail_pic_5" name="detail_pic_5" style="width:450px;" />
			...
			图片6&nbsp;：<input type="text"  id="detail_pic_6" name="detail_pic_6" style="width:450px;" />
			...
			图片7&nbsp;：<input type="text"  id="detail_pic_7" name="detail_pic_7" style="width:450px;" />
			...
			图片8&nbsp;：<input type="text"   id="detail_pic_8" name="detail_pic_8" style="width:450px;" />
			...
			图片9&nbsp;: <input type="text"   id="detail_pic_9" name="detail_pic_9" style="width:450px;" />
			...
			图片10&nbsp;：<input type="text"   id="detail_pic_10" name="detail_pic_10" style="width:450px;" />
			...
			图片11&nbsp;：<input type="text"   id="detail_pic_11" name="detail_pic_11" style="width:450px;" />
			...
			图片12&nbsp;：<input type="text"   id="detail_pic_12" name="detail_pic_12" style="width:450px;" />
			...
			图片13&nbsp;：<input type="text"  id="detail_pic_13" name="detail_pic_13" style="width:450px;" />
			...
			图片14&nbsp;：<input type="text"   id="detail_pic_14" name="detail_pic_14" style="width:450px;" />
			...
			图片15&nbsp;：<input type="text"   id="detail_pic_15" name="detail_pic_15" style="width:450px;" />
			...
			图片16&nbsp;：<input type="text"   id="detail_pic_16" name="detail_pic_16" style="width:450px;" />
			...
			图片17&nbsp;：<input type="text"   id="detail_pic_17" name="detail_pic_17" style="width:450px;" />
			...
			图片18&nbsp;：<input type="text"  id="detail_pic_18" name="detail_pic_18" style="width:450px;" />
			...
			图片19&nbsp;：<input type="text"  id="detail_pic_19" name="detail_pic_19" style="width:450px;" />
			...
			图片20&nbsp;：<input type="text"  id="detail_pic_20" name="detail_pic_20" style="width:450px;" />
			...
			图片21&nbsp;：<input type="text"   id="detail_pic_21" name="detail_pic_21" style="width:450px;" />
			...
			图片22&nbsp;：<input type="text" id="detail_pic_22" name="detail_pic_22" style="width:450px;" />
			...
			<input type="radio" name="isAvailable" value="0"> 停用<br/><br/>
 			<input type="radio" name="isOffShelves" value="0"> 上架&nbsp;&nbsp;&nbsp; 
 			<input type="radio" name="isOffShelves" value="1" checked> 下架<br/><br/> 
...
<script>
	...
	$(function(){
		...
		$('#saveProduct').form({   
		    url:'${rc.contextPath}/wechatGroup/save/add',   
		    onSubmit: function(){   
		        $.messager.progress();
		    },
		    success:function(data){
		        ...
		        if (data.status == 1){
		            window.location.href = "${rc.contextPath}/wechatGroup/list";
		        }else{
	    ...
	    $("#saveButton").click(function(){
			...
			}else if(!/^[0-9.]+$/.test(marketPrice) || !/^[0-9.]+$/.test(singlePrice) || !/^[0-9.]+$/.test(teamPrice) || !/^[0-9.]+$/.test(teamSupplyPrice)){
	    	...
	    	else if(marketPrice == "" || singlePrice == ""||teamPrice==""){
	    		$.messager.alert("提示","商品售价必填","info");
	    	}else if(parseFloat(singlePrice) >= parseFloat(marketPrice)){
	    		$.messager.alert("提示","单独购买价必须小于市场价","info");
	    	}else if(parseFloat(teamPrice)>=parseFloat(singlePrice)){
	    		$.messager.alert("提示","团购价必须小于单独购买价","info");
	    	}else if(stock == ""){
	    		$.messager.alert("提示","库存数必填","info");
