...
<div data-options="region:'center',title:'商品信息'" style="padding:5px;">
	<form id="saveProduct"  method="post">
		<fieldset>
			...
			库存数：<input  type="text" id="stock" name="stock" value="${stock?c!'0'}" style="width:70px;" readonly="readonly"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
			...
			单独购买价：<input  type="text" id="singlePrice" name="singlePrice" value="${mwebGroupProductEntity.singlePrice?string('#.##')!'0'}" style="width:70px;"/>&nbsp;<font color="red" style="italic">必填</font>&nbsp;&nbsp;
...
<script>
	...
	$(function(){
	    ...
	    $("#saveButton").click(function(){
	    	...
	    	else if(marketPrice == "" || singlePrice == ""||teamPrice==""||teamSupplyPrice==""){
