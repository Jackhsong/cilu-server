...
<div data-options="region:'center',title:'板块布局信息-新版本'" style="padding:5px;">
	<form id="saveCustomLayout"  method="post">
		<fieldset>
    		...
    		<a onclick="picDialogOpen('oneImage')" href="javascript:;" class="easyui-linkbutton">上传图片</a><font color="red">必填</font>&nbsp;<span id="oneImageTip" style="color:red">宽度：752px</span><br/>
			...
			<div id="two_div" style="width: 100%">
	    		...
	    		<a onclick="picDialogOpen('twoImage')" href="javascript:;" class="easyui-linkbutton">上传图片</a><font color="red">必填</font>&nbsp;<span id="twoImageTip" style="color:red">宽度：376px</span><br/>
            ...
            <div id="three_div" style="width: 100%">
                ...
                <a onclick="picDialogOpen('threeImage')" href="javascript:;" class="easyui-linkbutton">上传图片</a><font color="red">必填</font>&nbsp;<span id="threeImageTip" style="color:red">宽度：188px</span><br/>
            ...
            <div id="four_div" style="width: 100%">
                ...
                <a onclick="picDialogOpen('fourImage')" href="javascript:;" class="easyui-linkbutton">上传图片</a><font color="red">必填</font>&nbsp;<span id="fourImageTip" style="color:red">宽度：188px</span><br/>
	...
	$(function(){
		...
		$("#displayType2").change(function(){
			if($(this).is(':checked')){
                ...
                $('#three_div').hide();
                $('#four_div').hide();
                $('#oneImageTip').text('宽度：376px');
                $('#twoImageTip').text('宽度：376px');
			}
		});
        ...
        $("#displayType3").change(function(){
            if($(this).is(':checked')){
                ...
                $('#three_div').show();
                $('#four_div').show();
                $('#oneImageTip').text('宽度：188px');
                $('#twoImageTip').text('宽度：188px');
                $('#threeImageTip').text('宽度：188px');
                $('#fourImageTip').text('宽度：188px');
            }
        });
        ...
        $('#saveCustomLayout').form({
		    url:'${rc.contextPath}/customRegion24/saveOrUpdateCustomLayout',
		    onSubmit: function(){
		    ...
		    success:function(data){   
                ...
                if(res.status == 1){
                    $.messager.alert('响应信息',"保存成功",'info',function(){
                        window.location.href = '${rc.contextPath}/customRegion24/manageLayout/${regionId}';
                    });
