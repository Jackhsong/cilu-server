...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="padding: 5px;">
		<div id="cc" class="easyui-layout" data-options="fit:true" >  
	    	<div data-options="region:'north',title:'条件筛选-退款并退货订单处理',split:true" style="height: 160px;">
	    			...
	    			<tr>
                        ...
                        <td>
                            ...
                            <select name="financialAffairsCardId" id="financialAffairsCardId" >
                                ...
                                <option value="11"  >支付宝 心动慈露微信  1266647901</option>
...
//					{field : 'username', title : '用户名', width : 30, align : 'center'},
					...
					{field : 'realMoney', title : '退款金额', width : 20, align : 'center'},
...
//					{field : 'sendAddress', title : '发货地', width : 30, align : 'center'},
					...
					{field : 'fullName', title : '收货人', width : 25, align : 'center'},
					{field : 'mobileNumber', title : '收货手机', width : 30, align : 'center'},
					{field : 'ologChannel', title : '物流公司', width : 25, align : 'center'},
					{field : 'ologNumber', title : '运单号', width : 30, align : 'center'},
					{field : 'hidden', title : '操作', width : 70, align : 'center',
						formatter : function(value, row, index) {
							...
							if(row.status == 1){
								...
								a = '<a href="javaScript:;" onclick="dealWithApply(' + row.id + ')">待顾客退货</a> | ';
