...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="padding: 5px;">
		<div id="cc" class="easyui-layout" data-options="fit:true" >
			<div data-options="region:'north',title:'发货时效管理',split:true" style="height: 190px;">
				<form action="${rc.contextPath}/sellerAdminOrder/exportUnSettlementOrder" id="searchForm" method="post" >
						...
						<table class="search">
							...
							<tr>
                                <td class="searchName">发货时效是否超时：</td>
                                <td class="searchText">
...
//			});
			...
			$('#s_data') .datagrid(
			{
				...
				collapsible : true,
				idField : 'id',
				url : '${rc.contextPath}/sellerAdminOrder/jsonSendTimeoutOrderInfo',
				queryParams: {
                    sellerId: '${sellerId!"0"}',
