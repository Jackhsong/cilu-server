	...
	<div data-options="region:'center'" style="padding: 5px;">
		<div id="cc" class="easyui-layout" data-options="fit:true" >
			<div data-options="region:'north',title:'条件筛选-订单管理',split:true" style="height: 80px;">
				<form action="${rc.contextPath}/order/exportOrderLogisticAnalyzeDetail" id="searchForm" method="post" >
						<input type="hidden" id="sendTime" name="sendTime" value="${sendTime}"/>
						<input type="hidden" id="hour" name="hour" value="${hour}"/>
						<table>
							<tr>
								<td>${sendTime}订单发货后物流明细&nbsp;&nbsp;&nbsp;</td>
								<td>
	...
	<script>
		...
		$(function() {
			...
			$('#s_data') .datagrid(
			{
				...
				url : '${rc.contextPath}/order/jsonOrderLogisticAnalyzeDetail',
				loadMsg : '正在装载数据...',
				fitColumns : true,
				remoteSort : true,
				singleSelect : true,
