...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="padding: 5px;">
		<div id="cc" class="easyui-layout" data-options="fit:true" >
			<div data-options="region:'north',title:'条件筛选-问题件管理',split:true" style="height: 150px;">
	...
	<script>
		...
		$(function() {
			...
			$('#s_data') .datagrid(
			{
				...
				collapsible : true,
				idField : 'id',
				url : '${rc.contextPath}/order/jsonProblemOrderListInfo',
				loadMsg : '正在装载数据...',
				fitColumns : true,
				remoteSort : true,
				singleSelect : false,
				...
				columns : 
					[ [
						...
						{field : 'logisticsStatus', title : '物流状态', width : 80, align : 'center'},
