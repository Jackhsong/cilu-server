	...
	<div data-options="region:'center'" style="padding: 5px;">
		<div id="cc" class="easyui-layout" data-options="fit:true" >
			<div data-options="region:'north',title:'条件筛选-订单管理',split:true" style="height: 80px;">
				<form action="${rc.contextPath}/order/exportOrderSendTimeAnalyzeDetail" id="searchForm" method="post" >
	...
	<script>
		...
		$(function() {
			...
			$('#s_data') .datagrid(
			{
				...
				url : '${rc.contextPath}/order/jsonOrderSendTimeAnalyzeDetail',
				loadMsg : '正在装载数据...',
				fitColumns : true,
				remoteSort : true,
				singleSelect : true,
