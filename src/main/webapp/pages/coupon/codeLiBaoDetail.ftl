...
<div data-options="region:'center'" style="padding: 5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',title:'优惠码详细--<#if te?exists && te==1>单次<#else>多次</#if>',split:true" style="height: 100px;padding-top:10px">
	        <form id="searchForm" action="${rc.contextPath}/couponCode/exportCouponCodeLiBaoDetail" method="post" >
...
$(function(){
	...
	function showDetail(type,couponAccountId){
		var url = "${rc.contextPath}/couponCode/couponCodeLiBaoDetail/"+type+"/"+couponAccountId;
	...
	$(function(){
		$('#s_data').datagrid({
	        ...
	        striped: true,
	        collapsible:true,
	        url:'${rc.contextPath}/couponCode/jsonCouponCodeLiBaoDetail',
