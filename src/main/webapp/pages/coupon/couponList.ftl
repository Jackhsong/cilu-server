...
<div data-options="region:'center'" style="padding: 5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',title:'优惠券管理',split:true" style="height: 190px;">
...
<script>
	...
	function viewDetail(index){
		...
		var urlStr="${rc.contextPath}/coupon/couponAccountList/"+arr.rows[index].id;
	...
	$(function(){
		...
		$("#singleSendCouponByIdForm_couponType").combobox({
			url:'${rc.contextPath}/coupon/jsonCouponType',   
		    valueField:'code',   
		    textField:'text'
		});
		...
		$('#s_data').datagrid({
            ...
            collapsible:true,
            idField:'id',
            url:'${rc.contextPath}/coupon/jsonCouponInfo',
            loadMsg:'正在装载数据...',
            fitColumns:true,
            remoteSort: true,
            singleSelect:true,
            ...
            toolbar:[{
                    ...
                    text:'批量手机号发放优惠券',
                    handler: function(){
                    	$('#batchSendCouponByPhone_div').dialog('open');
                    }
                }],
            pagination:true
        });
	    	...
	    	buttons: [
	    	{
	    		...
	    		handler: function(){
	    			$('#createSingleCouponForm').form('submit',{
	    				url: "${rc.contextPath}/coupon/createSingleCoupon",
	    				onSubmit:function(){
	    	...
	    	buttons: [
	    	{
	    		...
	    		handler: function(){
	    			$('#singleSendCouponByIdForm').form('submit',{
	    				url: "${rc.contextPath}/coupon/sendCouponSingle",
	    				onSubmit:function(){
