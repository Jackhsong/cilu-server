...
<div data-options="region:'center',title:'优惠券管理'" style="padding: 5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',split:true" style="height: 150px;">
			<div id="searchDiv" style="height: 120px;padding: 15px">
		        <form id="searchForm" action="${rc.contextPath}/coupon/exportOrderDetail" method="post" >
		            <table class="search">
						<input id="couponId" name="couponId" value="${couponId}" hidden="true" />
		                <tr>
						...
						<tr>
		                	...
		                	<td class="searchName"></td>
							<td class="searchText">
                                <a id="exportBtn" onclick="exportOrderDetail()" href="javascript:;" class="easyui-linkbutton">导出订单明细</a>
							</td>
							<td class="searchName"></td>
...
$(function(){
	...
	function viewDetail(index){
		...
		var urlStr="${rc.contextPath}/coupon/couponOrderDetailList/"+arr.rows[index].id;
	...
	$(function(){
		$('#s_data').datagrid({
            ...
            rownumbers:true,
            idField:'id',
            url:'${rc.contextPath}/coupon/jsonCouponAccountInfo',
            loadMsg:'正在装载数据...',
            fitColumns:true,
            remoteSort: true,
