...
<div data-options="region:'center'" style="padding:5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',title:'品类馆格格推荐',split:true" style="height: 120px;">
			<br/>
...
function checkTwo() {
	...
	function edit(id) {
		...
		$('#display').hide();
		$.ajax({
			url: '${rc.contextPath}/categoryGGrecommend/findById?id=' + id,
			type:"POST",
			async:false,
			success: function(data) {
	...
	function updateActivity(row){
		$.ajax({
			url: '${rc.contextPath}/categoryGGrecommend/saveOrUpdate',
			type:"POST",
	...
	$(function() {
		...
		$('#s_data').datagrid({
            ...
            collapsible:true,
            idField:'id',
            url:'${rc.contextPath}/categoryGGrecommend/listInfo',
            loadMsg:'正在装载数据...',
            queryParams:{
