...
<div data-options="region:'center',title:'content'" style="padding:5px;">
	...
	<div id="searchDiv" class="datagrid-toolbar" style="height: 30px; padding: 15px">
		<form id="searchDivForm" action="${rc.contextPath}/analyze/seller" method="post">
	...
	<br/>
	<span style="padding:10px">订单数量</span>
	<div>
	<br/>
	...
	<br/>
	<span style="padding:10px">订单金额</span>
	<br/><br/>
	<table class="table table-bordered table-striped" width="100%">
		<tr>
			<!-- <th >商家ID</th> -->
...
function searchAll() {
	...
	$('#searchDivForm').attr("action", "seller").submit();
}

function exportAll() {
	$('input[name="isSearch"]').val("1");
	$('#searchDivForm').attr("action", "exportSellerResult").submit();
}
</script>
