            ...
            <table cellspacing="5" cellpadding="5">
            	<tr>
                    ...
                    <td>
	                    ...
	                    <input type="checkbox" name="isDisplay" value="0" />不展示
                    </td>
...
$(function(){
	...
	function editIt(index){
		...
		window.location.href = "${rc.contextPath}/qqbsBanner/edit/"+arr.rows[index].id
	}
	...
	function updateActivity(row){
		$.ajax({
			url: '${rc.contextPath}/qqbsBanner/updateOrder',
			type:"POST",
	...
	function displayIt(id,code){
    	$.messager.confirm("提示信息","确定修改展现状态吗？",function(re){
        	if(re){
            	$.messager.progress();
            	$.post("${rc.contextPath}/qqbsBanner/updateDisplayCode",{id:id,code:code},function(data){
	...
	$(function(){
		$('#s_data').datagrid({
            ...
            collapsible:true,
            idField:'id',
            url:'${rc.contextPath}/qqbsBanner/jsonBannerWindowInfo',
            loadMsg:'正在装载数据...',
            fitColumns:true,
            remoteSort: true,
            singleSelect:true,
            ...
            columns:[[
                ...
                {field:'displayName',    title:'对应名称/链接', width:60, align:'center',
                	formatter:function(value,row,index){
                		if(row.type == '网页'){
                			return '<a href="'+row.displayName+'" target="_blank">网页链接</a>';
                		}
                	}	
                },
                {field:'displayRemark',    title:'对应备注', width:60, align:'center'},
                {field:'bannerImage',    title:'BANNER图', width:40, height:40, align:'center',
                	formatter:function(value,row,index){
            ...
            toolbar:[{
                ...
                iconCls:'icon-add',
                handler:function(){
                    window.location.href = "${rc.contextPath}/qqbsBanner/addBanner"
                }
            }],
            pagination:true,
            rownumbers:true
