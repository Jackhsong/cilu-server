...
<div data-options="region:'center',title:'添加Banner信息'" style="padding:5px;">
	...
	<form id="savebannerWindow" action="${rc.contextPath}/qqbsBanner/save"  method="post">
		<fieldset>
			...
			<legend>Banner信息</legend>
			 ...
			 <#if bannerWindow.type?exists && (bannerWindow.type == 1)>
				...
				<input type="radio" name="type"  id="type2" value="2">组合&nbsp;&nbsp
				<input type="radio" name="type" id="type3" value="3">网页;
			<#elseif bannerWindow.type?exists && (bannerWindow.type == 3)>
				<input type="radio" name="type" id="type1" value="1">单品&nbsp;&nbsp;
				<input type="radio" name="type" id="type2" value="2">组合&nbsp;&nbsp
				<input type="radio" name="type" id="type3" value="3" checked>网页<br/><br/>
			<#else>
				<input type="radio" name="type" id="type1" value="1">单品&nbsp;&nbsp;
				<input type="radio" name="type" id="type2" value="2" checked>组合&nbsp;&nbsp
				<input type="radio" name="type" id="type3" value="3">网页<br/><br/>
			...
			<div id="groupSale_div">
			 ...
			 <span id="groupSaleName" style="color:red"></span>&nbsp;&nbsp;&nbsp;<span id="groupSaleRemark" style="color:red"></span><br/><br/>
			 	 ...
			 	 <!-- 特卖类型为网页时 -->
			<div id="url_div">
			 网页链接: <input type="text" id="url" name="url" style="width:500px;"  value="<#if bannerWindow.url?exists>${bannerWindow.url}</#if>" /><br/><br/>
			 </div>
			 
			 展现状态:
			 <#if bannerWindow.isDisplay?exists>
				  <#if bannerWindow.isDisplay == 1 >
					 <input type="radio" name="isDisplay" value="1" checked>展现&nbsp;&nbsp;&nbsp;
					 <input type="radio" name="isDisplay" value="0">不展现<br/><br/>
				 <#elseif bannerWindow.isDisplay == 0 >
				 	 <input type="radio" name="isDisplay" value="1">展现&nbsp;&nbsp;&nbsp;
					 <input type="radio" name="isDisplay" value="0" checked>不展现<br/><br/>
			      <#elseif bannerWindow.isDisplay == -1 >
			     	 <input type="radio" name="isDisplay" value="1" checked>展现&nbsp;&nbsp;&nbsp;
					 <input type="radio" name="isDisplay" value="0">不展现<br/><br/>
			     </#if>
			</#if>
		...
		$("#saveButton").click(function(){
			...
			if(type == 1 && $.trim(product) == ""){
				...
				if(type ==3 ){
					...
					$.messager.progress();
					$.ajax({ 
					       url: '${rc.contextPath}/qqbsBanner/checkProductTime',
					       type: 'post',
					       dataType: 'json',
