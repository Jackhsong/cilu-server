...
<div data-options="region:'center'" style="padding: 5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',title:'sku管理',split:true" style="height: 190px;">
		...
		<div data-options="region:'center'" >
    		...
    		<!-- 调库存begin -->
   	 		<div id="editStock_div" style="width:1100px;height:600px;padding:20px 20px;">
   	 			<p>
   	 				sku名称：<span id="span_baseName"></span>&nbsp;&nbsp;
	   	 			sku条码：<span id="span_barcode"></span>&nbsp;&nbsp;
	   	 			sku编码：<span id="span_code"></span>&nbsp;&nbsp;
   	 				sku名称：<span id="span_sellerName"></span>&nbsp;&nbsp;
   	 			</p>
   	 			<p>
