		...
		<div data-options="region:'north',title:'商家退款统计',split:true" style="height: 100px;padding-top:10px">
			...
			<table>
				<tr>
					...
					<td>&nbsp;&nbsp;<a id="searchBtn" onclick="exportData()" href="javascript:;" class="easyui-linkbutton" style="width:100px" >导出结果</a></td>
				</tr>
			</table>
		<form>
		</div>
...
$(function(){
	$('#s_data').datagrid({
        ...
        columns:[[
            ...
            {field:'totalSellerMoney',    title:'商家承担', width:40, align:'center'},
            {field:'totalGegejiaMoney',    title:'心动慈露承担', width:40, align:'center'}
        ]],
        rownumbers:true
    });
});
