...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" style="padding: 5px;">
		<div id="cc" class="easyui-layout" data-options="fit:true" >
			<div data-options="region:'north',title:'订单申诉管理',split:true">
			</div>
	...
	<script>
		...
		function deal(index){
			...
			$('#dealForm_orderId').val(arr.rows[index].id);
			...
			var url = '${rc.contextPath}/timeoutOrder/jsonTimeoutReasonCode?isAvailable=1&id='+arr.rows[index].reasonId;
...
//			});
	            ...
	            buttons:[{
	                ...
	                handler:function(){
	                    $('#dealForm').form('submit',{
	                        url:"${rc.contextPath}/timeoutOrder/dealComplain",
	                        onSubmit:function(){
			...
			$('#s_data') .datagrid(
			{
				...
				collapsible : true,
				idField : 'id',
				url : '${rc.contextPath}/timeoutOrder/jsonComplainOrderInfo',
                queryParams: {
				...
				columns : [ [
						...
						{field : 'isTimeout', title : '是否超时', width : 25, align : 'center',
						...
						{field : 'oStatusDescripton', title : '订单状态', width : 30, align : 'center'},
						...
						{field : 'sendTimeType', title : '发货时效', width : 70, align : 'center'},
