...
<div data-options="region:'center'" style="padding:5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',title:'首页品牌推荐管理',split:true" style="height: 90px;">
		...
		<div data-options="region:'center'" >
		    ...
		    <div id="editCustomGGRecommendDiv" class="easyui-dialog" style="width:800px;height:700px;padding:15px 20px;">
		        <form id="editCustomGGRecommendForm" method="post">
                    ...
                    <p>
                        <span>品牌ID：</span>
                        <span><input type="text" name="brandId" id="brandId" maxlength="10" style="width: 200px;"/></span><span style="color: red">*</span>
...
function strToDate(str) {
 ...
 return date;
	...
	function edit(id) {
		...
		$('#display').hide();
		$.ajax({
			url: '${rc.contextPath}/brandRecommend/findById?id=' + id,
			type:"POST",
			async:false,
			success: function(data) {
	...
	function deleteIt(id){
	    $.messager.confirm("提示信息","确定删除么？",function(re){
	        if(re){
	            $.messager.progress();
	            $.post("${rc.contextPath}/brandRecommend/delete",{id:id},function(data){
	                $.messager.progress('close');
	                if(data.status == 1){
	...
	function updateActivity(row){
		$.ajax({
			url: '${rc.contextPath}/brandRecommend/saveOrUpdate',
			type:"POST",
	...
	$(function() {
		...
		$('#s_data').datagrid({
            ...
            collapsible:true,
            idField:'id',
            url:'${rc.contextPath}/brandRecommend/listInfo',
            loadMsg:'正在装载数据...',
            singleSelect:false,
            fitColumns:true,
            remoteSort: true,
