...
<div data-options="region:'center'" style="padding: 5px;">
	<div id="cc" class="easyui-layout" data-options="fit:true" >
		<div data-options="region:'north',title:'优惠码详细--<#if te?exists && te==1>单次<#else>多次</#if>',split:true" style="height: 150px;padding-top:10px">
	        <form id="searchForm" action="${rc.contextPath}/mwebGroupCouponCode/exportCouponCodeDetail" method="post" >
...
<script>
	...
	function showDetail(type,couponAccountId){
		var url = "${rc.contextPath}/mwebGroupCouponCode/couponCodeOrderDetail/"+type+"/"+couponAccountId;
	...
	$(function(){
		$('#s_data').datagrid({
	        ...
	        striped: true,
	        collapsible:true,
	        url:'${rc.contextPath}/mwebGroupCouponCode/jsonCouponCodeDetail',
