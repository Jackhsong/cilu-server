...
@Controller
@RequestMapping("qqbsBanner")
public class QqbsBannerController
{
    
    @Resource(name = "qqbsBannerWindowService")
    private QqbsBannerWindowService qqbsBannerWindowService;
    
    @Resource(name = "activitiesCommonService")
    private ActivitiesCommonService activitiesCommonService;
    
    private Logger log = Logger.getLogger(QqbsBannerController.class);
        ...
        throws Exception
    {
        ...
        //前端默认显示为展现
        bannerWindow.setIsDisplay((byte)-1);
        mv.addObject("bannerWindow", bannerWindow);
        mv.setViewName("qqbsBanner/qqbsBannerForm");
        return mv;
    }
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("qqbsBanner/qqbsBannerManage");
        return mv;
    }
    ...
    public ModelAndView save(HttpServletRequest request, //
        ...
        @RequestParam(value = "type", required = true) byte type,// 1单品；2组合特卖；3网页;4自定义页面（暂时不用）
        ...
        @RequestParam(value = "url", required = false) String url)//网页链接
        throws Exception
    {
        ModelAndView mv = new ModelAndView();
        BannerWindowEntity bannerWindow = new BannerWindowEntity();
...
//        bannerWindow.setImage((image.indexOf(ImageUtil.getPrefix()) > 0) ? image : (image + ImageUtil.getPrefix() + ImageUtil.getSuffix(ImageTypeEnum.v1banner.ordinal())));
        ...
        if (editId != 0)
        {
            ...
            BannerWindowEntity bwe = qqbsBannerWindowService.findBannerWindowById(editId);
            qqbsBannerWindowService.update(bannerWindow);
        ...
        {
            qqbsBannerWindowService.save(bannerWindow);
        }
        
        mv.setViewName("redirect:/qqbsBanner/list");
        return mv;
    }
        ...
        throws Exception
    {
        ...
        List<BannerWindowEntity> bannerWindowList = qqbsBannerWindowService.findAllBannerWindow(para);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        List<Map<String, Object>> resultList = qqbsBannerWindowService.packageBannerWindowList(bannerWindowList);
        resultMap.put("rows", resultList);
        int total = qqbsBannerWindowService.countBannerWindow(para);
        ...
        throws Exception
    {
        ...
        int resultStatus = qqbsBannerWindowService.updateDisplayCode(para);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        if (resultStatus != 1)
        {
    ...
    {
        ModelAndView mv = new ModelAndView();
        BannerWindowEntity bannerWindow = qqbsBannerWindowService.findBannerWindowById(id);
        ...
        throws Exception
    {
        ...
        para.put("id", id);
        int resultStatus = qqbsBannerWindowService.updateOrder(para);
        Map<String, Object> resultMap = new HashMap<String, Object>();
        if (resultStatus != 1)
        {
            resultMap.put("status", 0);
        ...
        throws Exception
    {
        ...
        boolean isExist = qqbsBannerWindowService.checkIsExist(para);
        if (!isExist)
        {
            resultMap.put("status", 0);
        ...
        resultMap = qqbsBannerWindowService.checkProductTime(para);
        return JSON.toJSONString(resultMap);
