...
//            }
            ...
            if (type == 0)
            {
                ...
                tableHead =
                    new String[] {"退款ID", "订单号", "用户名", "退款发起时间", "最新更新时间", "退货需求", "退款状态", "打款状态", "收货状态", "退款金额", "退款数量", "退款商品ID", "退款商品编码", "商品名称", "购买数量", "收货人", "收货手机",
                        "所属商家", "客服处理备注", "退款账号", "心动慈露退款账户", "财务选择状态", "商家货款", "商家运费", "商家差价", "心动慈露货款", "心动慈露运费", "心动慈露差价", "退款说明"};
            }
            if (type == 1)
            {
                fileName = "退款订单查询结果";
                tableHead =
                    new String[] {"退款ID", "订单号", "用户名", "退款发起时间", "最新更新时间", "退款状态", "打款状态", "退款金额", "退款数量", "退款商品ID", "退款商品编码", "商品名称", "购买数量", "收货人", "收货手机", "所属商家","退款原因","客服处理备注",
                        "退款账号", "心动慈露退款账户", "财务选择状态", "商家货款", "商家运费", "商家差价", "心动慈露货款", "心动慈露运费", "心动慈露差价", "退款说明"};
            }
            if (type == 2)
            {
                fileName = "退款退货订单查询结果";
                tableHead =
                    new String[] {"退款ID", "订单号", "用户名", "退款发起时间", "最新更新时间", "退款状态", "打款状态", "收货状态", "退款金额", "退款数量", "退款商品ID", "退款商品编码", "商品名称", "购买数量", "收货人", "收货手机", "所属商家", "退款原因",
                        "客服处理备注", "退款账号", "心动慈露退款账户", "财务选择状态", "商家货款", "商家运费", "商家差价", "心动慈露货款", "心动慈露运费", "心动慈露差价", "退款说明"};
            }
    ...
    @ControllerLog(description = "心动慈露自动退款")
    ...
    @ControllerLog(description = "导出心动慈露自动退款")
        ...
        @RequestParam(value = "endTime", required = false, defaultValue = "") String endTime)
    {
        ...
        try
        {
            ...
            workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.createSheet("心动慈露自动退款数据");
    ...
    @ResponseBody
    @ControllerLog(description = "退款退货管理-心动慈露直接退款")
