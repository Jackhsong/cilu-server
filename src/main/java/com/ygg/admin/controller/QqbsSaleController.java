...
public class QqbsSaleController
{
    ...
    private Logger log = Logger.getLogger(QqbsSaleController.class);
        ...
        throws Exception
    {
        ...
        mv.setViewName("qqbsSale/qqbsSaleForm");
        return mv;
    }
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("qqbsSale/qqbsIndexSaleManage");
        return mv;
    }
        ...
        throws Exception
    {
        ...
        // saleWindow.setImage((image.indexOf(ImageUtil.getPrefix()) > 0) ? image : (image + ImageUtil.getPrefix() +
        // ImageUtil.getSuffix(ImageTypeEnum.v1sell.ordinal())));
        ...
        if (editId != 0)
        {
            ...
            QqbsSaleWindowEntity sw = qqbsSaleWindowServcie.findSaleWindowById(editId);
        ...
        mv.setViewName("redirect:/qqbsSale/list");
        return mv;
    }
