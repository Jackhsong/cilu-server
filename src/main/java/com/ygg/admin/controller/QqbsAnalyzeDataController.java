...
@Controller
@RequestMapping("/qqbsDataAnalyze")
public class QqbsAnalyzeDataController {
    
	   Logger logger = Logger.getLogger(QqbsAnalyzeDataController.class);
	   
	   @Resource
	   private QqbsAnalyzeService qqbsAnalyzeService;
...
月度数据统计)
	    ...
	    @ControllerLog(description = "数据统计-心动慈露月度数据统计")
	    ...
	    {
	        ModelAndView mv = new ModelAndView("qqbsDataAnalyze/qqbsMonthAnalyze");
	        ...
	        Map<String, Object> rowsInfo = qqbsAnalyzeService.monthAnalyze(para);
...
月度统计
        ...
        @ControllerLog(description = "数据统计-导出心动慈露月度统计")
        ...
        )
        {
            ...
            try
            {
                ...
                para.put("payTimeEnd", payTimeEnd);
                para.put("selectDate", selectDate);
                Map<String, Object> resultList = qqbsAnalyzeService.monthAnalyze(para);
                ...
                String codedFileName = "心动慈露月度统计结果";
                // 进行转码，使其支持中文文件名
...
数据魔方)
	    ...
	    public ModelAndView todaySaleTop(HttpServletRequest request,//
	        ...
	        throws Exception
	    {
	        ModelAndView mv = new ModelAndView("qqbsDataAnalyze/todaySaleTopAnalyze");
	        Map<String, Object> para = new HashMap<String, Object>();
	        DateTime begin = null;
	        if (!"".equals(selectDate))
	        {
	        ...
	        para.put("payTimeEnd", payTimeEnd);
	        // 获得商品销售排行榜
	        List<Map<String, Object>> rowsInfo = qqbsAnalyzeService.todaySaleTop(para);
	        mv.addObject("rows", rowsInfo);
	        // 获得折线图数据
	        Map<String, Object> data = qqbsAnalyzeService.saleLineData(begin);
...
商品统计)
	        ...
	        throws Exception
	    {
	        ...
	        if (type == 0)
	        {
	            mv.setViewName("qqbsDataAnalyze/productNum");
	        }
	        else
	        {
	            mv.setViewName("qqbsDataAnalyze/productMoney");
	        }
	        ...
	        if ((isSearch == 1) && (!"".equals(selectDate)) && (start != 0) && (stop != 0) && (start <= stop))
	        {
	            ...
	            para.put("payTimeBegin", payTimeBegin);
	            para.put("payTimeEnd", payTimeEnd);
	            Map<String, Object> result = qqbsAnalyzeService.productDataCustom(para);
