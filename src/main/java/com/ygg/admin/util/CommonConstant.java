...
public class CommonConstant
{
     ...
     * 心动慈露短信内容前缀
     */
    public static final String SMS_PREFIX = "【心动慈露】";
    ...
    public static final String QQBS_WEIXIN_TOKEN_URL =
        YggAdminProperties.getInstance().getPropertie("qqbs_weixin_token_url") == null ? "http://120.26.137.44:9080/ygg-hqbs/wechatToken" : YggAdminProperties.getInstance()
