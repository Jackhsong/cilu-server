 ...
 * @version $Id: QqbsAccountEntity.java 12176 2016-05-18 02:54:05Z wuhuyun $
 * @since 2.0
 */
public class QqbsAccountEntity extends BaseEntity
{
    ...
    public boolean isEmptyQueryCriteria()
    {
        return StringUtils.isEmpty(getNickName()) && getAccountId() == NOT_EXIST_ACCOUNT_ID;
    }
