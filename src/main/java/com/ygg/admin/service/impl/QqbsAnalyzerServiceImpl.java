 ...
 *
 */
@Repository("qqbsAnalyzerService")
public class QqbsAnalyzerServiceImpl implements QqbsAnalyzeService
{
            ...
            throws Exception
    {
        ...
        List<Map<String, Object>> result = orderDao.findOrderSalesRecordForQqbsMonthAnalyze(para);
        // 将数据按月天分组 key为天
    ...
    public List<Map<String, Object>> todaySaleTop(Map<String, Object> para)
        throws Exception
    {
        List<Map<String, Object>> reList = orderDao.findQqbsAllTodaySaleRelOrderProduct(para);
    ...
    public Map<String, Object> saleLineData(DateTime date) throws Exception
    {
        ...
        List<Map<String, Object>> data1 = orderDao.findQqbsSaleDataByDate(para);
        ...
        List<Map<String, Object>> data2 = orderDao.findQqbsSaleDataByDate(para);
    ...
    public Map<String, Object> productDataCustom(Map<String, Object> para)
            throws Exception
    {
        List<Map<String, Object>> productSaleInfoList = productDao.findQqbsProductSalesRecord(para);
