...
@Service("bannerWindowService")
public class BannerWindowServiceImpl implements BannerWindowService
{
    @Resource
        ...
        throws Exception
    {
        ...
        return bannerWindowDao.save(window);
    }
        ...
        throws Exception
    {
        ...
        return bannerWindowDao.update(window);
    }
    ...
    public int countBannerWindow(Map<String, Object> para)
        throws Exception
    {
        return bannerWindowDao.countBannerWindow(para);
    }
    ...
    public List<BannerWindowEntity> findAllBannerWindow(Map<String, Object> para)
        throws Exception
    {
        return bannerWindowDao.findAllBannerWindow(para);
    }
    ...
    public BannerWindowEntity findBannerWindowById(int id)
        throws Exception
    {
        return bannerWindowDao.findBannerWindowById(id);
    }
    ...
    public int updateDisplayCode(Map<String, Object> para)
        throws Exception
    {
        return bannerWindowDao.updateDisplayCode(para);
    }
    ...
    public int updateOrder(Map<String, Object> para)
        throws Exception
    {
        return bannerWindowDao.updateOrder(para);
    }
